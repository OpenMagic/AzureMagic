    ...
    public static class WindowAzureStorageEmulatorManager
    {
        ...
        public static void StartEmulator()
        {
            lock (ThisLock)
            {
                ...
                {
                    LogTo.Trace("Windows Azure Storage Emulator is already running.");
                    return;
                }

                LogTo.Trace("Starting Windows Azure Storage Emulator...");
                ...
                LogTo.Trace("Started Windows Azure Storage Emulator.");
            }
        }
        ...
        public static void StopEmulator()
        {
            lock (ThisLock)
            {
                if (!IsEmulatorRunning())
                {
                    LogTo.Trace("Windows Azure Storage Emulator is not running.");
                    return;
                }

                LogTo.Trace("Stopping Windows Azure Storage Emulator...");
                ...
                LogTo.Trace("Stopped Windows Azure Storage Emulator.");
            }
        }
    }
}